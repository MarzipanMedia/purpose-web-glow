...
const Contact = () => {
    ...
    try {
      ...
      const response = await fetch("https://formsubmit.co/ajax/ben@marzipan.com.au", {
        ...
        body: JSON.stringify({
          ...
          _template: "table",
          _autoresponse: "Thank you for contacting Marzipan Media, Sydney. We've received your message and will get back to you shortly.",
          _replyto: data.email,
        }),
      });
      ...
      // Success handling
      setIsSuccess(true);
      toast.success("Hooray - Message sent successfully! We'll be in touch soon.");
      form.reset();
      ...
      toast.error("Dang! There was a problem sending your message. Please try again.");
    } finally {
  ...
  return (
    <div>
      <MetaHead 
        title="Contact Us" 
        description="Get in touch with the team at Marzipan. Contact our sustainable web design and AI-driven SEO agency in Sydney, Australia." 
      />
      <Header />
      <main className="min-h-[70vh]">
        <div className="container-custom py-16">
          ...
          <p className="text-lg text-muted-foreground mb-12 max-w-2xl slide-up stagger-item">
            Ready to elevate your brand's online presence? We'd love to hear from you.
          </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="space-y-10 slide-up stagger-item">
              ...
              <div>
                <h3 className="text-xl font-semibold mb-4">Let's Get Social</h3>
