  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow">
        {/* Hero Section */}
        <section className="py-16 md:py-24 bg-gradient-to-br from-brandBlue/10 via-white to-marzipan/20">
          <div className="container-custom">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-6 animate-fade-in">
                ...
                <h2 className="text-2xl md:text-3xl font-display text-brandBlue">
              ...
              <div className="relative mt-6 lg:mt-0">
                <div className="bg-white rounded-xl shadow-xl p-6 md:p-8 relative z-10">
                  ...
                  <h3 className="text-xl font-display font-semibold mb-4">No-Fluff Fix-It List</h3>
                  <div className="space-y-3">
                    {includedItems.slice(0, 5).map((item, index) => (
                      <div key={index} className="flex items-start">
                        <Check className="text-brandBlue mr-2 mt-1 h-5 w-5 flex-shrink-0" />
                        <span>{item}</span>
                      </div>
                    ))}
                  </div>
                  <div className="mt-6 pt-6 border-t border-gray-200 text-center">
                    <span className="text-lg font-semibold">Normally: <span className="line-through text-gray-500">$499</span></span>
                    <div className="text-2xl font-bold text-brandBlue mt-1">FREE</div>
                    <div className="text-sm text-gray-500 mt-1">Limited to 5 spots this month</div>
                  </div>
                </div>
                <div className="absolute -bottom-4 -right-4 w-full h-full bg-marzipan/40 rounded-xl -z-10"></div>
              </div>
            </div>
          </div>
        </section>
              ...
              {steps.map((step, index) => (
                <Card key={index} className="border-none shadow-md hover:shadow-lg transition-shadow">
                  <CardContent className="p-6 text-center">
                    <div className="bg-brandBlue/10 rounded-full w-12 h-12 flex items-center justify-center mx-auto mb-4">
                      <span className="text-xl font-bold text-brandBlue">{index + 1}</span>
                    </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
              <div className="space-y-4">
                {includedItems.map((item, index) => (
                  <div key={index} className={`flex items-center ${index === 0 ? 'font-semibold text-lg' : ''}`}>
                    {index > 0 && <Check className="text-brandBlue mr-2 h-5 w-5 flex-shrink-0" />}
                    <span>{item}</span>
                  </div>
                ))}
              </div>
              <div className="bg-gray-50 p-6 rounded-lg">
                <div className="flex items-center mb-4">
                  <BarChart3 className="text-brandBlue h-6 w-6 mr-3" />
                  <h3 className="text-xl font-display font-semibold">Your Shine Score</h3>
                </div>
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <div className="w-full bg-gray-200 rounded-full h-2.5">
                      <div className="bg-brandBlue h-2.5 rounded-full" style={{ width: "70%" }}></div>
                    </div>
                  </div>
                  <div>
                    <div className="flex justify-between mb-1">
                    ...
                    <div className="w-full bg-gray-200 rounded-full h-2.5">
                      <div className="bg-brandBlue h-2.5 rounded-full" style={{ width: "50%" }}></div>
                    </div>
                  </div>
                  <div>
                    <div className="flex justify-between mb-1">
                    ...
                    <div className="w-full bg-gray-200 rounded-full h-2.5">
                      <div className="bg-brandBlue h-2.5 rounded-full" style={{ width: "80%" }}></div>
                    </div>
                  </div>
                  <div>
                    <div className="flex justify-between mb-1">
                    ...
                    <div className="w-full bg-gray-200 rounded-full h-2.5">
                      <div className="bg-brandBlue h-2.5 rounded-full" style={{ width: "60%" }}></div>
                    </div>
                  </div>
                </div>
        ...
        <section className="py-16 bg-brandBlue/10">
          <div className="container-custom">
            <div className="max-w-2xl mx-auto text-center">
              <h2 className="text-3xl md:text-4xl font-display font-bold mb-6">Why It's Free (For Now)</h2>
        ...
        <section className="py-16 bg-white">
          <div className="container-custom">
            <div className="max-w-2xl mx-auto text-center">
              <h2 className="text-3xl md:text-4xl font-display font-bold mb-6">What Happens Next</h2>
              <p className="text-lg">
        ...
        {/* Application Form */}
        <section id="application-form" className="py-16 bg-white scroll-mt-16">
          <div className="container-custom">
            <div className="max-w-2xl mx-auto">
              <div className="text-center mb-8">
                <h2 className="text-3xl md:text-4xl font-display font-bold mb-4">Apply For Your Free Fix-It List</h2>
              ...
              {isSubmitted ? (
                <div className="bg-green-50 border border-green-200 rounded-lg p-8 text-center">
                  <h3 className="text-2xl font-display font-semibold mb-4">Application Received!</h3>
                  <p className="mb-4">
                    ...
                    <Form {...form}>
                      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              <FormLabel>Best Email</FormLabel>
                              <FormControl>
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              <FormLabel>What's your biggest website worry? (optional)</FormLabel>
                              <FormControl>
                                <Textarea 
        ...
        <section className="py-16 bg-gray-50">
          <div className="container-custom">
            <div className="text-center mb-8">
              <h2 className="text-xl font-display font-medium mb-6">Trusted by Purpose-Driven Brands</h2>
            </div>
            <CertificationLogos />
          </div>
        </section>
