      ...
      <main className="flex-grow">
        ...
        <section className="py-16 bg-white">
          <div className="container-custom">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
              <div className="p-6 bg-marzipan/30 rounded-lg animate-fade-in" style={{ animationDelay: "0.1s" }}>
                <div className="text-4xl font-display font-bold text-brandBlue mb-2">90%</div>
                <p className="text-foreground/80">Lower Carbon Emissions Than Traditional Websites</p>
              </div>
              <div className="p-6 bg-marzipan/30 rounded-lg animate-fade-in" style={{ animationDelay: "0.2s" }}>
                <div className="text-4xl font-display font-bold text-brandBlue mb-2">2x</div>
                <p className="text-foreground/80">Faster Page Load Times Than Industry Average</p>
              </div>
              <div className="p-6 bg-marzipan/30 rounded-lg animate-fade-in" style={{ animationDelay: "0.3s" }}>
                <div className="text-4xl font-display font-bold text-brandBlue mb-2">15+</div>
          ...
          <div className="container-custom">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {testimonials.map((testimonial, index) => (
                <div 
                  key={index} 
                  className="bg-gradient-subtle p-6 rounded-lg border border-marzipan/30 animate-fade-in"
        ...
        <section className="py-16 bg-brandBlue text-white">
          <div className="container-custom text-center">
            ...
            <p className="text-lg text-white/80 max-w-2xl mx-auto mb-8 animate-fade-in" style={{ animationDelay: "0.1s" }}>
