...
// Map service types to service URLs
const serviceLinks = {
          ...
          {testimonials.map((testimonial, index) => (
            ...
            >
              {testimonial.serviceType && (
                <div className="mb-3">
                  <Link 
                    to={serviceLinks[testimonial.serviceType as keyof typeof serviceLinks] || '/services'} 
                    className="inline-block text-xs px-2 py-1 bg-brandBlue/10 text-brandBlue rounded-full hover:bg-brandBlue/20 transition-colors"
                  >
                    {testimonial.serviceType}
                  </Link>
                </div>
              ...
              <div className="mt-4 text-right">
                <Link 
                  to="/projects" 
                  className="text-sm text-brandBlue inline-flex items-center gap-1 hover:underline"
                >
                  View case study
                </Link>
              </div>
