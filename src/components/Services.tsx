  ...
  return (
    <section className="py-20 bg-white dark:bg-gray-900">
      <div className="container-custom">
        <div className="text-center max-w-3xl mx-auto mb-16 defer-animate">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {services.map((service, index) => (
            <Link 
              key={index}
              to={service.link}
              className="group p-6 bg-background rounded-lg border border-border/50 hover:border-border transition-colors dark:bg-gray-800 dark:border-gray-700 dark:hover:border-gray-600 defer-animate"
            >
