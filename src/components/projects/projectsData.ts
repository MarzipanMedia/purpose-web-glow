...
export const projects: ProjectData[] = [
  {
    ...
    description: "Social media strategy and content creation for an award-winning short film to inspire Indigenous school children to reach for the stars",
    features: ["Indigenous Knowledge", "Educational Content", "Interactive Learning", "Cultural Preservation", "Accessibility Design"],
    color: "bg-[#5A3D2B]",
    textColor: "text-white",
    slug: "jarli",
    client: "Jarli Education",
    services: ["Web Development", "Educational Content", "Cultural Consulting", "Accessibility Design"],
    websiteUrl: "https://jarli.edu.au",
